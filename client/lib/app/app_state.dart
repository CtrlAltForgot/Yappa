...
class AppState extends ChangeNotifier {
  ...
  bool get selectedCameraEnabled => selectedLocalVoiceState.cameraEnabled;
  ...
  Future<String?> authenticate({
    ...
    try {
      ...
      _rememberedUsersByServer[auth.server.id] = auth.user.name;
  ...
  Future<VoicePresenceState> updateSelectedVoiceState({
    ...
    if (micMuted != null || speaking != null) {
  ...
  Future<void> _restoreSession(
    ...
    _rememberedUsersByServer[me.server.id] = me.user.name;
