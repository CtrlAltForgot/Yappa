...
`../architecture/PERSISTENT_CHAT.md` defines the storage and verification contract. Security
...
`../architecture/SERVER_PORTABILITY.md` defines the supported-host and parity contract. Windows
...
contract and remaining credential boundaries are in `../maintainers/RELEASE_ENGINEERING.md`.
...
[Project home](../../README.md) · [Documentation index](../README.md) · [Public security policy](../../SECURITY.md)
